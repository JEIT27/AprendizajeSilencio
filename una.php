...
<?php 
$sql="select * from imagenes where clasificacion='A' GROUP BY palabra ASC;"; 
...
echo "
	...
	<a href = 
	'http://localhost/senas_senass/una.php?clasificacion=".$row["palabra"] . "'>".$row['palabra']."</a>&nbsp;&nbsp;&nbsp;";
...
<table bgcolor='gray' bordercolor='gray' cellpadding='0' cellspacing='40px' align='center' border='1px' width='70%'>
<tr>
...
<br>
				<br>
				<a href="index.html"><input type="submit" value="Regresar a la página principal" class="boton"></a>
			</div>
		</div>
	</div>
