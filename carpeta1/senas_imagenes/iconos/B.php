...
<?php
	...
	<header>
	    ...
	    <span class="Estilo2"> PALABRAS CON LA LETRA &quot;A&quot;. </span></h1>
...
echo "<td bgcolor='".$color."'><h4><a href = 'http://localhost/senas_senas/B.php?clasificacion=".$row["palabra"] . "'>".$row['palabra']."<h4></a></td>
<td bgcolor='".$color."'></td>";
echo "</tr>"; 
$cont++;
} 
