...
<form id="form1" name="form1" method="post" action="">
  ...
  <p>
    ...
    <div id="hdr">
                        ...
                        <h1>&nbsp;</h1>
                        <nav>      
                        <form action="palabramodificada.php" method="post">
   <p><span class="Estilo6 Estilo1 Estilo4">Ingresa la palabra a modificar:</span>
      <input type="text" name="cviejo" /> 
   <p><br/> 
     <br/>
     <span class="Estilo4 Estilo6 Estilo5">Ingresa la palabra nueva: </span>
      <input type="text" name="cnuevo" />
    </p>
   <p>&nbsp;</p>
   <p><br/> 
      <br/>
