...
echo "
	...
	<a href = 
	'http://localhost/senas_senass/alfabeto/d.php?clasificacion=".$row["palabra"] . "'>".$row['palabra']."</a>&nbsp;&nbsp;&nbsp;";
...
<br>
				<br>
				<a href="../index.html"><input type="submit" value="Regresar a la página principal" class="boton"></a><br><br>
